                        ...
                        this.$axios.post("{{ route('admin.sales.cart.store') }}", {customer_id: customer.id})
                            .then(function(response) {
                                if (response.data && response.data.redirect_url) {
                                    ...
                                    self.$emitter.emit('add-flash', { type: 'error', message: 'Failed to create cart: Invalid response' });
                                }
                            })
                            .catch(function (error) {
                                self.$emitter.emit('add-flash', { type: 'error', message: error.response?.data?.message || 'Failed to create cart' });
                            });
                    },
                }
            });
