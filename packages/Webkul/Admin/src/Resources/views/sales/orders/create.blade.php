                        ...
                        this.$axios.post("{{ route('admin.sales.cart.items.store', $cart->id) }}", formData)
                            .then(response => {
                                ...
                                if (response.data.data && response.data.data.items !== undefined) {
                                    ...
                                    let errorMessage = response.data.data?.message || response.data.message || 'Error adding product to cart';
                            ...
                            .catch(error => {
                                ...
                                let message = error.response?.data?.message || error.message || 'Error adding product to cart';
