                    ...
                    <table class="{{ core()->getCurrentLocale()->direction }}">
                        ...
                        <tbody>
                            @foreach ($invoice->items as $item)
                                <tr>
                                    <td>
                                        @if(isset($item->additional['ari_partstream']) && $item->additional['ari_partstream'])
                                            {{ $item->additional['sku'] }}
                                        @elseif($item->product)
                                    ...
                                    <td>
                                        {{ $item->name }}
                                        @if(isset($item->additional['ari_partstream']) && $item->additional['ari_partstream'])
                                            <br><small style="color: #E13124; font-weight: bold;">ARI PartStream</small>
                                        @endif
                ...
                <div class="summary">
                    <table class="{{ core()->getCurrentLocale()->direction }}">
                        <tbody>
                            ...
                            @if(isset($invoice->additional_shipping_amount) && $invoice->additional_shipping_amount > 0)
                                <tr>
                                    <td>Additional Shipping</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->additional_shipping_amount, true) !!}</td>
                                </tr>
                            @endif
                            ...
                            @php
                                $totalDue = $invoice->base_grand_total - $invoice->order->base_grand_total_invoiced;
                            @endphp
                            ...
                            @if($totalDue > 0)
                                <tr>
                                    <td>Total Paid</td>
                                    <td>-</td>
                                    <td>{!! core()->formatBasePrice($invoice->order->base_grand_total_invoiced) !!}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <b>{!! core()->formatBasePrice($totalDue) !!}</b>
                                    </td>
                                </tr>
                            @endif
                        </tbody>
