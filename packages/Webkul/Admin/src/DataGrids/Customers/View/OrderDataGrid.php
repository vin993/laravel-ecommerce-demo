...
class OrderDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('orders')
            ->leftJoin(DB::raw('(SELECT order_id, first_name, last_name, email, address, city, state, country FROM addresses WHERE address_type = "'.OrderAddress::ADDRESS_TYPE_BILLING.'" GROUP BY order_id) as order_address_billing'), 'order_address_billing.order_id', '=', 'orders.id')
            ...
            ->groupBy('orders.id', 'order_payment.method', 'orders.increment_id', 'orders.base_grand_total', 'orders.created_at', 'orders.channel_name', 'orders.status', 'orders.cart_id', 'order_address_billing.email', 'order_address_billing.first_name', 'order_address_billing.last_name', 'order_address_billing.address', 'order_address_billing.city', 'order_address_billing.state', 'order_address_billing.country');
