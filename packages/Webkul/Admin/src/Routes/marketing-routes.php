...
Route::prefix('marketing')->group(function () {
    ...
    Route::prefix('promotions')->group(function () {
         ...
         */
        Route::controller(FreeShippingController::class)->prefix('free-shipping')->group(function () {
            Route::get('', 'index')->name('admin.free-shipping.index');

            Route::put('update', 'update')->name('admin.free-shipping.update');
        });
    });
