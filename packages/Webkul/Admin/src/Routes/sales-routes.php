...
Route::prefix('sales')->group(function () {
    ...
    Route::controller(InvoiceController::class)->prefix('invoices')->group(function () {
        ...
        Route::get('view-pdf/{id}', 'viewInvoicePDF')->name('admin.sales.invoices.view_pdf');
    ...
    Route::controller(OrderController::class)->prefix('orders')->group(function () {
        ...
        Route::get('edit/{id}', 'edit')->name('admin.sales.orders.edit');

        Route::post('update/{id}', 'update')->name('admin.sales.orders.update');
