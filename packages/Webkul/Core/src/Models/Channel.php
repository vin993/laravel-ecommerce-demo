...
class Channel extends TranslatableModel implements ChannelContract
{
    ...
    {
        if (class_exists(\Webkul\Category\Models\CategoryProxy::class)) {
            return $this->belongsTo(\Webkul\Category\Models\CategoryProxy::modelClass(), 'root_category_id');
        }

        return $this->belongsTo(self::class, 'root_category_id');
    }
