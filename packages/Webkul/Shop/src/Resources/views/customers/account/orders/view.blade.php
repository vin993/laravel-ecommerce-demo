                ...
                >
                    ...
                    <div class="max-md:hidden">
                        ...
                        @if(isset($ariItems) && count($ariItems) > 0)
                            <div class="mt-8">
                                <div class="rounded-t-xl border border-b-0 px-6 py-4" style="background: linear-gradient(135deg, #E13124 0%, #c12a1e 100%);">
                                    <p class="text-base font-bold text-white">
                                        ARI PartStream Items ({{ count($ariItems) }})
                                    </p>
                                </div>

                                <div class="relative overflow-x-auto rounded-b-xl border">
                                    <table class="w-full text-left">
                                        <thead class="border-b border-zinc-200 bg-zinc-100 text-sm text-black">
                                            <tr class="[&>*]:font-medium [&>*]:px-6 [&>*]:py-4">
                                                <th scope="col">
                                            ...
                                            @foreach ($ariItems as $item)
                                                <tr class="border-b bg-white align-top font-medium [&>*]:px-6 [&>*]:py-4">
                                                    ...
                                                    <td data-value="@lang('shop::app.customers.account.orders.view.information.product-name')">
                                                        {{ $item->name }}
                                                        @if($item->brand)
                                                            <br><span class="text-sm text-gray-600">Brand: {{ $item->brand }}</span>
                                                        @endif
                                                    </td>

                                                    <td data-value="@lang('shop::app.customers.account.orders.view.information.price')">
                                                        {{ core()->formatPrice($item->price, $order->order_currency_code) }}
                                                    </td>
                                                    ...
                                                    <td data-value="Supplier">
                                                        <span class="font-semibold text-red-600">
                                                            {{ strtoupper(str_replace('_', ' ', $item->selected_supplier)) }}
                                                        </span>
                                                    </td>

                                                    <td data-value="@lang('shop::app.customers.account.orders.view.information.subtotal')">
                                                        {{ core()->formatPrice($item->total, $order->order_currency_code) }}
                                                    </td>
                                                </tr>
                                            @endforeach
                    ...
                    <div class="grid gap-4 md:hidden">
                        ...
                        @if(isset($ariItems) && count($ariItems) > 0)
                            <div class="rounded-lg border bg-gray-100">
                                <div class="rounded-t-lg px-4 py-3" style="background: linear-gradient(135deg, #E13124 0%, #c12a1e 100%);">
                                    <p class="text-sm font-bold text-white max-sm:text-xs">
                                        ARI PartStream Items ({{ count($ariItems) }})
                                    </p>
                                </div>

                                <div class="grid gap-2.5 p-0">
                                    @foreach ($ariItems as $item)
                                        <div class="rounded-md border-t bg-white px-4 py-2">
                                            <p class="pb-2 text-sm font-medium">
                                                {{ $item->name }}
                                            </p>
                                            ...
                                            <div class="grid gap-1.5 text-xs font-medium">
                                                ...
                                                <div class="flex justify-between">
                                                    ...
                                                    <span>{{ core()->formatPrice($item->price, $order->order_currency_code) }}</span>
                                                </div>
                                                ...
                                                <div class="flex justify-between">
                                                    ...
                                                    <span>{{ core()->formatPrice($item->total, $order->order_currency_code) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
